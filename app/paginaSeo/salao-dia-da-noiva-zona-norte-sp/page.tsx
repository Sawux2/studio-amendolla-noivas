...
import styles from "app/styles/BelezaNoivasSP.module.css"; // Mantenha o mesmo CSS
import GaleriaDeFotos from "app/components/GaleriaDeFotos";
import FeaturesCards from "app/components/FeaturesCards";
import ServiceSimulator from "app/components/calculadora";

const serviceData = {
  title: "Salão Dia da Noiva Zona Norte SP - Studio Amendolla",
  description:
    "Prepare-se para o seu grande dia com os melhores serviços de beleza para noivas na Zona Norte de São Paulo. Maquiagem, penteados e tratamentos exclusivos no Studio Amendolla.",
  detailedDescription: `
    No Studio Amendolla, oferecemos serviços de beleza especializados para noivas na Zona Norte de São Paulo. Nossa equipe de profissionais altamente qualificados está pronta para transformar o seu dia especial em um momento inesquecível. Com maquiagem impecável, penteados elegantes e tratamentos relaxantes, garantimos que você estará radiante no seu casamento.`,
...
const faqData = [
  {
    question: "Quais serviços são oferecidos para noivas na Zona Norte de SP?",
    answer:
  ...
  {
    question: "Como agendar um horário no salão para o dia da noiva?",
    answer:
  ...
  {
    question: "O Studio Amendolla atende em domicílio na Zona Norte?",
    answer:
      "Sim, oferecemos atendimento a domicílio para maior comodidade das noivas na Zona Norte de São Paulo. Consulte-nos para mais detalhes.",
  },
  {
    question: "Qual é o valor médio dos serviços para noivas?",
    answer:
