...
const pageData = {
  article: {
    headline: "Penteados Profissionais Jardim Brasil | Studio Amendolla",
    description: 
      "Penteados profissionais para Jardim Brasil no Studio Amendolla. Localizado na Vila Nivi, com fácil acesso do Jardim Brasil.",
...
const PenteadoJardimBrasilPage = () => {
  return (
    <div className={styles.container}>
      ...
      <div className={styles.contentContainer}>
        <div className={styles.imageContainer}>
          <Image
            ...
            alt="Penteados Profissionais Jardim Brasil"
            width={500}
            height={333}
            loading="lazy"
        ...
        <div className={styles.textContent}>
          <h2>Penteados para Jardim Brasil</h2>
          <p>
            Em nosso studio na Avenida Julio Buono, 2386, Vila Nivi, oferecemos serviços premium 
            de penteados com localização privilegiada para clientes do Jardim Brasil.
          </p>
        </div>
      </div>
      ...
      <a
        href="https://wa.me/5511977670498?text=Olá%2C%20gostaria%20de%20agendar%20um%20penteado%20(Jardim%20Brasil)."
      ...
      <section className={styles.faqSection}>
        ...
        <div className={styles.faqGrid}>
          ...
          <details className={styles.faqItem}>
            ...
            <p>Acesso rápido, apenas alguns minutos do Jardim Brasil.</p>
          </details>
          <details className={styles.faqItem}>
...
export default PenteadoJardimBrasilPage;
