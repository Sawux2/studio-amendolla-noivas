...
const keywordsList = [
  ...
  export const metadata: Metadata = {
    title: 'Dia de Noiva Tucuruvi SP | Studio Amendolla',
...
const pageData = {
  article: {
    headline: "Dia de Noiva Tucuruvi - Experiência Exclusiva | Studio Amendolla",
    description: "Transforme seu dia especial com nosso serviço exclusivo de Dia de Noiva em Tucuruvi. Atendimento personalizado e profissional próximo à sua região.",
  ...
  faq: [
    {
      question: "Qual a distância do studio para Tucuruvi?",
      answer: "Nosso studio na Vila Nivi fica muito próximo de Tucuruvi, com fácil acesso e estacionamento."
    },
    {
      question: "Fazem atendimento a domicílio em Tucuruvi?",
      answer: "Sim, oferecemos atendimento a domicílio em toda região de Tucuruvi e adjacências."
    },
    {
  ...
  services: [
    ...
    },
    {
      ...
      description: "Experiência exclusiva próxima a Tucuruvi",
      image: "/images/dia-de-noiva.webp",
    }
  ],
  breadcrumb: [
  ...
  images: [
    {
      ...
      description: "Dia de Noiva Tucuruvi - Studio Amendolla",
      width: 1200,
      height: 800,
      name: "Dia de Noiva Tucuruvi",
      datePublished: "2024-02-01"
...
export default function DiaDeNoivaTucuruviPage() {
  return (
    <div className={styles.container}>
      ...
      <div className={styles.contentContainer}>
        ...
        <div className={styles.textContent}>
          <h2>Dia de Noiva Próximo a Tucuruvi</h2>
          <p>
            Localizado estrategicamente na Avenida Julio Buono, 2386 - Vila Nivi, 
            o Studio Amendolla está a poucos minutos de Tucuruvi. 
      ...
      <a
        href="https://wa.me/5511977670498?text=Olá%2C%20gostaria%20de%20conhecer%20o%20pacote%20dia%20de%20noiva%20em%20Tucuruvi."
      ...
      <section className={styles.servicesSection}>
        <h2>Serviços Especiais para Tucuruvi</h2>
