...
const BelezaParaMadrinhasSPPage = () => {
  const articleData = {
    ...
    url: "https://studio-amendolla-noivas.vercel.app/paginaSeo/beleza-para-madrinhas-em-sao-paulo"
  };
  ...
  return (
    <div className={styles.container}>
      ...
      <ImageObjectSchema data={{
        ...
        contentUrl: `https://studio-amendolla-noivas.vercel.app${pageData.article.image}`,
        description: pageData.article.description,
        width: 500,
        height: 333,
        name: pageData.article.headline,
