...
const MaquiagemNoivaPeleNegraPage = () => {
  ...
  const pageData = {
    ...
    breadcrumb: [
      ...
      { name: 'Maquiagem para Noiva em Pele Negra', url: 'https://studio-amendolla-noivas.vercel.app/paginaSeo/maquiagem-noiva-pele-negra' },
    ],
    images: serviceData.images.map((image, index) => ({
      ...
      width: 600,
      height: 400,
      name: `Imagem ${index + 1} de Maquiagem para Noiva em Pele Negra`, // Nome único para cada imagem
