...
export const metadata: Metadata = {
  title: 'Dia da Noiva na Vila Nivi | Studio Amendolla',
  description: 'Viva uma experiência única no Dia da Noiva na Vila Nivi, Zona Norte de São Paulo. Atendimento exclusivo e personalizado para tornar seu dia inesquecível.',
  keywords: 'dia da noiva vila nivi, dia de noiva zona norte, salão de noivas vila nivi, maquiagem e penteado noivas vila nivi'
};

const pageData = {
  article: {
    headline: "Dia da Noiva na Vila Nivi | Studio Amendolla",
    description: "Viva uma experiência única no Dia da Noiva na Vila Nivi, Zona Norte de São Paulo. Atendimento exclusivo e personalizado para tornar seu dia inesquecível.",
  ...
  images: [
    {
      ...
      description: "Dia da Noiva na Vila Nivi - Studio Amendolla",
      width: 1200,
      height: 800,
      name: "Dia da Noiva Vila Nivi",
      datePublished: "2024-02-01"
    }
  ]
};

export default function DiaDaNoivaVilaNiviPage() {
  return (
    <div className={styles.container}>
      ...
      <div className={styles.contentContainer}>
        ...
        <div className={styles.textContent}>
          ...
          <p>
            No Studio Amendolla, oferecemos uma experiência única para o Dia da Noiva na Vila Nivi. 
            Nossa equipe especializada cuida de cada detalhe para que você se sinta confiante e deslumbrante no seu grande dia. 
            Localizados na Zona Norte de São Paulo, proporcionamos um ambiente acolhedor e serviços personalizados.
          </p>
        </div>
      </div>
      ...
      <a
        href="https://wa.me/5511977670498?text=Olá%2C%20gostaria%20de%20saber%20mais%20sobre%20o%20pacote%20de%20Dia%20da%20Noiva%20na%20Vila%20Nivi."
